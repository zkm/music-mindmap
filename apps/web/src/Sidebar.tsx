    ...
    if (!selectedTagId || !tag) {
        return (
            <div className="placeholder">
                <h2>Pick a tag</h2>
                <p>
                    Tap any node in the mind map to see the artists that share that tag. The size of
                    each node tracks how many artists carry that tag (and, when enabled, how much
        ...
        <div className="artist-card">
            ...
            <div>
                ...
                <div className="meta">
                    ...
                    {artist.yearMin
                        ? ` · ${artist.yearMin}–${artist.yearMax ?? artist.yearMin}`
                        : ""}
                </div>
